...
class home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Mount_item> mountItem = [
      Mount_item(
              ...
              children: [
                Row(
                  children: [
                    Padding(
                      ...
                      child: CircleAvatar(
                        radius: 30.0,
                        backgroundImage: NetworkImage(home.mohammadImage),
                      ),
                    ),
                ...
                Container(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) => BuildListItem(mountItem[index],context),
                    itemCount: mountItem.length,
